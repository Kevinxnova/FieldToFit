...
def run():
    ...
    if len(reqs) != 22 or len(set(reqs)) != 22 or len(subreqs) != 91 or len(set(subreqs)) != 91:
        errors.append('Current baseline requires 22 distinct requirements and 91 distinct subrequirements')
    for error in errors:
