...
def run():
    ...
    if len(reqs) != 21 or len(set(reqs)) != 21 or len(subreqs) != 85 or len(set(subreqs)) != 85:
        errors.append('Current baseline requires 21 distinct requirements and 85 distinct subrequirements')
    for error in errors:
