...
export function AboutFieldToFit() {
  ...
  return <div className="platform-page platform-about"><VisitReady/>
    <header className="platform-hero brand-story">
      ...
      <p className="platform-lead">{pick(...searchPages['/about'].description)}</p>
