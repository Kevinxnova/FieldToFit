...
当前运行版本 **v1.0.2**，正式网站 [fieldtofit.top](https://fieldtofit.top)。27 项既有资料、品牌页面与 10 项公开 MCP 工具已通过指定公网检查。现有 10 条动态；新增五类 27 个持续关注主体与 curated_watch，精选 MCP 共 12 项；长期维护仍待验，详见 REQ。
...
当前状态以 REQ 总表及子项为准；每项验证只证明对应提交、环境和输入。规划不等于功能已经上线。Metis 记录见[历史附录](../CHANGELOG.md#附录metis-历史更新记录)与[归档](archive/README.md)。
