...
本稿完成后，用户已授权更新网站。现在已实现五类网页、目录、资料导出与 curated_watch；原有数据库不变。具体版本及发布证据见[验收记录](../../validation/2026-09-11-continuous-watch.md)，REQ 以[总表](../../../FieldToFit-PM.md)为准；运行维护与日常客户端验收没有因此关闭。
