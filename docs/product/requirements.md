# FieldToFit REQ list · 平台基线 P2

更新日期：2026-09-11。**现行需求与状态唯一入口。** 当前公开版本 **v1.0.0**，已有 27 项精选对象、10 项精选 MCP 工具及双入口/关于页；公网读取证据见[品牌验收](../validation/2026-09-10-fieldtofit-brand.md)。本轮 P2 对齐重点动态与精选资源两条线、分点本期重点、跟踪主体表；具体首发名单待确认，新展示尚未开发。
...
- 旧 200 资源 / 100 论文 / 60 任务包 / 12 案例目标失效。已有 27 项公开对象；下一批以[具体首发清单](launch-selection.md)逐项确认，发布质量门槛优先。
...
| [REQ-Y-01](requirements/for-you.md#req-y-01) | For you 本期重点 | .01–.04 | 部分实现；范围与缺口见子项 | S2 |
| [REQ-Y-02](requirements/for-you.md#req-y-02) | For you 重点动态与精选资源 | .01–.04 | 部分实现；范围与缺口见子项 | S2 |
