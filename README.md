...
**当前运行 v1.0.5，已部署并通过公网验收。** [本版更新与部署状态](docs/releases/v1.0.5.md)。 CW1 五类 27 个持续关注主体及第 12 项精选 MCP 已上线并通过公网验收，见[持续关注验收](docs/validation/2026-09-11-continuous-watch.md)。 2026-09-10 已验证公开网站及 10 项精选 MCP 工具，见[品牌与公网验收](docs/validation/2026-09-10-fieldtofit-brand.md)。2026-09-11 已上线并核验 10 条动态（含 DeepSeek-V4.1-Flash）、分点解读、阅读目录及第 11 项精选 MCP 工具；[验收与部署状态](docs/validation/2026-09-11-reading.md)。
